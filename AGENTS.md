...
1. Make sure to upload in the task output-in the UI it says: "All files in task". Make a zip file with the format of "Iteration_{message_number}", where message number is the current message number starting at 0 (ex if first message sent to you: {Iteration_0}).
